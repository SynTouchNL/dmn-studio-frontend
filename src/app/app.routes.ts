...
export const routes: Routes = [
    ...
    // Deployment routes
    {
        ...
        canActivate: [canActivateAuthRole],
        data: {
            role: ROUTE_ROLES.DEPLOYMENT_LIST
        }
    },
    {
        ...
        canActivate: [canActivateAuthRole],
        data: {
            role: ROUTE_ROLES.DEPLOYMENT_CREATE
        }
    },
    {
        path: 'deployments/:id',
        ...
        canActivate: [canActivateAuthRole],
        data: {
            role: ROUTE_ROLES.DEPLOYMENT_DETAIL
        }
    },
    ...
    },
    {
        ...
        canActivate: [canActivateAuthRole],
        data: {
            role: ROUTE_ROLES.DMN_VERSION_CREATE
        }
    },
    {
